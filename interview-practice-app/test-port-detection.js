// ポート3008での最終テスト
const testWithCorrectPort = async () => {
  try {
    console.log('🧪 ポート3008でのAPI呼び出しテスト');
    
    const response = await fetch('http://localhost:3008/api/interview/generate-question', {
      method: 'POST',
